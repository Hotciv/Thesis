...
f = open('standard_classifiers_results.csv', 'w')
wrt = writer(f)
# TODO: repeat the experiment 10x, average results and get standard deviations
header = ['Dataset', 'Classifier', 'ACC', 'TPR', 'f1']
wrt.writerow(header)
...
for ds_cnt, ds in enumerate(datasets):
    ...
    for name, clf in zip(names, classifiers):
        ...
        # header = ['Dataset', 'Classifier', 'ACC', 'TPR', 'f1']
        wrt.writerow([ds_cnt, name, ACCs.mean(), TPRs.mean(), f1s.mean()])
